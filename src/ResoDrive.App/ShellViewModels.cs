...
{
    public static MediaBrush Success { get; } = Create("#6CCB5F");
    public static MediaBrush Error { get; } = Create("#FF7878");
    public static MediaBrush Warning { get; } = Create("#FFB946");
    public static MediaBrush Info { get; } = Create("#60CDFF");
    public static MediaBrush Muted { get; } = Create("#A9A9A9");
    public static MediaBrush Disabled { get; } = Create("#919191");
...
public sealed class MountRow : NotifyBase
{
    ...
    public string LocationDisplay => string.IsNullOrWhiteSpace(Settings.ConnectionHost)
        ? DriveDisplay
        : $"{DriveDisplay}  ·  {Settings.ConnectionHost}";
